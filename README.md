...
- `run_reductions`: Specifies whether t-SNE and UMAP dimensionality reductions should be performed (default is FALSE).
...
- Added `run_reductions` option to allow users to choose whether to perform t-SNE and UMAP dimensionality reductions.
